...
| 7 | Статусы всех спек `ts/docs/specs/*.md` приведены к `--help` | строки «Статус:» (38 команд + 5 платформенных) | закоммичена `1fa849c` |
| 8 | Реестр нереализованных спек | `docs/specs-backlog.md` | закоммичена (коммит с этой строкой) |
...
**Итог 2026-09-10:** все восемь строк закрыты. Дальше — только по новым спекам или реализациям:
реализованная команда уходит из реестра, её статус правится в спеке.
