...
Остаток шага: два кластера дежурных заглушек резолва и три независимо изобретённые фабрики
`_resolve_to` / `_patch_resolve`, плюс общий посев SQLite (`store.bootstrap` + INSERT клиентов),
повторённый в 6 файлах.
