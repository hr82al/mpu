...
Статус: реализовано — сверено 2026-09-10 по `mpu sheet batch-get --help` (команда в справке; поверхность флагов построчно не сверялась). Ранее: к реализации (заморожена 2026-08-27; язык записи покрыт голденом
