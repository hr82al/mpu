...
Статус: реализовано — сверено 2026-09-10 по `mpu copy-dev --help` (команда в справке; поверхность флагов построчно не сверялась). Ранее: к реализации (заморожена 2026-08-28; механизм сверен с рабочей
