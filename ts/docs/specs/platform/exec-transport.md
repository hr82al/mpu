...
Статус: к реализации (адаптирована 2026-08-04 под один бинарь: транспорт
исполняется с машины пользователя, пути env-файла и ssh-ключей — его
окружение; заморожена 2026-08-17). Реализовано 2026-08-17 всё, кроме detach
(едет с `specs/run-js.md`) и разбора логов контейнера (с `specs/health.md`).
