...
Статус: реализовано — сверено 2026-09-10 по `mpu mr view --help` (команда в справке; поверхность флагов построчно не сверялась). Ранее: к реализации (заморожена 2026-08-27; формы сняты живьём на MR,
коды выхода разведены, голдены в `fixtures/mr-read/`)
