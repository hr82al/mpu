/**
 * Тело `multipart/form-data` для запросов Kaiten
 * (`docs/specs/platform/kaiten-http.md`, раздел «Запрос»): части, их
 * заголовки, экранирование имени файла и закрывающая граница.
 *
...
/**
 * Тип содержимого файловой части по расширению имени. Саму таблицу спека
 * не задаёт — перечислены расширения, которые команды `mpu kiten`
 * прикладывают к карточке; всё прочее закрывает умолчание, названное
 * спекой прямо.
 */
