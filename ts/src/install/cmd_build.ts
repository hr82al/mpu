...
пустая XDG_CONFIG_HOME равна незаданной), абсолютный путь. Кандидат
подходит, если в нём есть deno.jsonc и main.ts; ни один не подошёл —
отказ называет все три места.
