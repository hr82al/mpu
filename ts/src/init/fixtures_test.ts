...
/** Golden-файлы `mpu init`, скопированные в testdata модуля. */
const FIXTURES: readonly string[] = ["err-no-api-key.txt", "err-no-url.txt"];

const channelDir = new URL("../../docs/specs/fixtures/init/", import.meta.url);
