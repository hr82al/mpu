 ...
 * встреченных единиц: подсказка чинит вход тем же алфавитом, которым он
 * написан, — к `1ч15` подсказывается `1ч15м`, а не `1ч15m`. Смешение
 * алфавитов при этом допустимо и разбирается (`1ч15m` = 75 минут) — дело
 * не в разборе, а в том, чтобы не переучивать пишущего кириллицей.
 */
