...
export const groups: readonly CommandGroup[] = [
  ...
  },
  {
    ...
    // первым молча — ровно то, из-за чего эта порция и появилась
    // (`CLAUDE.md`, «У одного факта один источник»).
    summary: "Telegram от имени личного аккаунта: сообщения, диалоги, вход",
  ...
  },
  {
    ...
    path: ["code"],
    summary:
      "перед правкой кода: кого заденет, есть ли копия, занято ли имя, цел ли путь",
