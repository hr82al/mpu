...
поверхности не бывает: анализатора она не открывает.`,
  examples: [
    "mpu code mentions path: src/orders/mod.ts in: sl-back",
    "mpu code mentions path: src/orders/mod.ts in: sl-back:docs",
  ],
  policy: "ro",
  argsSchema,
