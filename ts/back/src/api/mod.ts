 ...
 *
 * Половина семейства читающая; пишущая едет следующей поставкой. До
 * неё её имён нет нигде: неизвестная подкоманда получает индекс группы
 * и код 2 — подпроцесса, которому её можно было бы отдать, больше нет
 * (порция 97).
 */
